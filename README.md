...
The slides for the tutorial are available in both English and Spanish

- [Slides in English](https://diegoquintanav.github.io/dlt-tutorial/en/slides)
- [Slides in Spanish](https://diegoquintanav.github.io/dlt-tutorial/es/slides)

You can build and preview the slides using the provided Makefile in the `slides` directory. Use `make help` from the `slides` directory to see available commands.
