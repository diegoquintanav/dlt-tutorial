...
Ten en cuenta que los modelos de Pydantic tienen algunas diferencias respecto al tipado habitual; consulta la [documentación](https://dlthub.com/docs/general-usage/schema-contracts#use-pydantic-models-for-data-validation).
...
No dudes en ponerte en contacto si tienes alguna pregunta o sugerencia: <mailto:daquintanav@gmail.com>
